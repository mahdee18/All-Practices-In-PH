...
import ponddith from "../assets/ponddith.json";
import { ShoppingCartIcon } from "@heroicons/react/24/solid";
import { Link } from "react-router-dom";

const Home = () => {
  return (
    <div className="my-container flex flex-col items-center justify-between lg:flex-row my-container">
      {/* Text Content */}
      ...
      <div className="relative lg:w-1/2 ">
        <div className="w-full lg:w-4/5 lg:ml-auto h-56  sm:h-96">
          <Lottie animationData={ponddith} loop={true} />
        </div>
      </div> 
    </div>
  );
